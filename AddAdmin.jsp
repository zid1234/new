		...
		<div class="side-navbar-wrapper">
			...
			<div class="main-menu">
				...
				<ul id="side-main-menu" class="side-menu list-unstyled">
					...
					<li><a href="AddAdmin.jsp"> <i class="icon-form"></i>Add
							New Admin
					</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								<spr:form class="form-horizontal" action="reg.htm" method="POST" commandName="admin">
								Admin Name    :<spr:input path="adminName"/></br></br>
								isMasterId &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<spr:input path="isMaster"/></br></br>
								Admin Email   :<spr:input path="adminEmail"/></br></br>
								Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<spr:input path="adminPass"/></br></br>
