				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								<spr:form class="form-horizontal" action="addCrime.htm" commandName="crate">
								City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;<spr:input path="City"/></br></br>
								Latitude:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;<spr:input path="Lat"/></br></br>
								Longitude:
								&nbsp;&nbsp;&nbsp;&nbsp;<spr:input path="Lan"/></br></br>
								Rating:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;<spr:input path="rating"/></br></br>
